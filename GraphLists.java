...
class Heap
{
    ...
    public void siftUp( int k) 
    {
        ...
        /*While distance value at the current element. Is less than the distance value at k / 2.
        Keep dividing going up the list to insert the element at the correct place*/
...
class Graph {
    ...
    public void MST_Prim(int s) {
        ...
        for (v = 0; v <= V; v++) {
            System.out.println("v = " + v + " distance = " + dist[v] + " parent = " + parent[v]);
        }
    ...
    public void SPT_Dijkstra(int s) {
        ...
        for (v = 0; v <= V; v++) {
            System.out.println("v = " + toChar(v) + " parent = " + toChar(parent[v]) + " distance = " + dist[v]);
